...
# NEW: Compare black hole surface entropy to Chajar core temperature to reveal internal boundary and estimate minimal entropy volume
...
# Estimate entropy density at Chajar temperature
entropy_density_chajar = (4/3) * a_rad * T_tangent**3  # J/K/m^3
volume_required = S_bh / entropy_density_chajar        # m^3 to contain black hole entropy at Chajar T

# Schwarzschild radius and volume for reference (10 solar mass BH)
M_solar = 1.98847e30
mass_bh = 10 * M_solar
r_s = 2 * G * mass_bh / c**2
