...
# 📂 Script Name: Entropy Energy Temperature_2.1
# Figure 60
...
def temperature_from_flux_planck(F_nu, nu=1.8e14):
    """
    Estimate temperature from flux density using Planck's law (Wien approx).
    Allows varying frequency nu to evaluate scaling effects.
    """
    numerator = h * nu
...
if __name__ == "__main__":
    ...
    print(df[['Flux_MAGH', 'Temp_from_MAGH', 'Temp_Planck_MAGH_1.8e14', 'Temp_Planck_MAGH_3e14', 'Temp_Planck_MAGH_1e13']].head())

    plot_flux_vs_temperature(df)

# ✅ Visualizes how Planck temperature changes with frequency — key to identifying scaling limits of classical theory
