...
# Overlay known physical temperature benchmarks for reference
# Figure 62
...
for label, temp in reference_points.items():
    plt.axvline(temp, linestyle='--', linewidth=1, label=label)

plt.title("Residuals Between Entropy-Based Temp and Planck Temp with Reference Points")
